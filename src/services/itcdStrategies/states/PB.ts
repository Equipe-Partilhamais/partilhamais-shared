...
const FAIXAS_CAUSA_MORTIS = [
    { limit: 125_000, rate: 0.02 },   // art. 6º, I, "a"
    { limit: 400_000, rate: 0.04 },   // "b"
    { limit: 1_000_000, rate: 0.06 }, // "c"
    { limit: Infinity, rate: 0.08 },  // "d"
];

const FAIXAS_DOACAO = [
    { limit: 125_000, rate: 0.02 },   // art. 6º, II, "a"
    { limit: 1_000_000, rate: 0.04 }, // "b"
    { limit: 2_000_000, rate: 0.06 }, // "c"
    { limit: Infinity, rate: 0.08 },  // "d"
];
...
export const PBStrategy: ItcdStrategy = {
    calculate({ baseValue, taxType }: ItcdStrategyParams): ItcdResult {
        ...
        const { totalTax, memory } = calculateMarginalTax(
            safeBaseValue,
