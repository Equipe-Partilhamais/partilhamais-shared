...
const FAIXAS_CAUSA_MORTIS = [
    { limit: 100_000, rate: 0 },      // art. 4º, V — isenção por quinhão
    { limit: 200_000, rate: 0.04 },   // art. 9º, II, "a"
    { limit: 300_000, rate: 0.06 },   // "b"
    { limit: Infinity, rate: 0.08 },  // "c"
];

// Tabela própria do art. 9º, I. Não há isenção geral por valor mínimo na doação.
const FAIXAS_DOACAO = [
    { limit: 200_000, rate: 0.03 },   // art. 9º, I, "a"
    { limit: 300_000, rate: 0.035 },  // "b"
