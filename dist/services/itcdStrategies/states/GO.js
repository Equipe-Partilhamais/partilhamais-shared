...
const FAIXAS_ART_78 = [
    { limit: 25000, rate: 0.02 }, // I  — até R$ 25.000,00
    { limit: 200000, rate: 0.04 }, // II — sobre o que exceder R$ 25.000,00 até R$ 200.000,00
    { limit: 600000, rate: 0.06 }, // III
    { limit: Infinity, rate: 0.08 }, // IV — teto da Res. SF nº 9/1992
];
exports.GOStrategy = {
    calculate({ baseValue }) {
        const safeBaseValue = baseValue || 0;
        const { totalTax, memory } = (0, utils_1.calculateMarginalTax)(safeBaseValue, FAIXAS_ART_78);
        return {
            taxAmount: totalTax,
